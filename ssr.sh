...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/halluboys/xzvnct/main/ssrmu"
...
wget -O /usr/bin/renew-ssr https://raw.githubusercontent.com/halluboys/xzvnct/main/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
