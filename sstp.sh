...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/halluboys/xzvnct/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/halluboys/xzvnct/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
