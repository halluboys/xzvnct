...
wget https://raw.githubusercontent.com/bokiroke1/carok/main/bbr.sh && chmod +x bbr.sh && ./bbr.sh
wget https://raw.githubusercontent.com/bokiroke1/carok/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
wget -O running "https://raw.githubusercontent.com/halluboys/xzvnct/main/running.sh"
