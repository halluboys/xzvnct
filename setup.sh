...
#install TrojanGo
wget https://raw.githubusercontent.com/halluboys/xzvnct/main/update/ins-trojango.sh && chmod +x ins-trojango.sh && screen -S Trojan-go ./ins-trojango.sh
...
echo " "
echo "=================================-HALUBOYS-===========================" | tee -a log-install.txt
