...
state=Indonesia
locality=Indonesia
organization=HaluHalu
organizationalunit=HaluHalu
commonname=HaluHalu
email=hammysayang@gmail.com
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/halluboys/xzvnct/main/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/halluboys/xzvnct/main/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/halluboys/xzvnct/main/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/halluboys/xzvnct/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/haluboys/xzvnct/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O renew "https://raw.githubusercontent.com/haluboys/xzvnct/main/renew.sh"
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : Haluboy"  | tee -a log-install.txt
